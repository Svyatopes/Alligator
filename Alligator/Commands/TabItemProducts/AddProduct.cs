...
namespace Alligator.UI.Commands.TabItemProducts
{
    class AddProduct : CommandBase
    {
        ...
        public override void Execute(object parameter)
        {
            ...
            _viewModel.ProductToAdd.Category = _viewModel.SelectedCategoryAddProduct;
            ...
            {
                Name = _viewModel.ProductToAdd.Name,
                Category = _viewModel.ProductToAdd.Category,
                ProductTags = new List<ProductTagModel>()
            };

            foreach (var productTag in _viewModel.ProductToAdd.ProductTags)
            {
